...
#ifndef APPSONAIR_APPLINK_SWIFT_H
#define APPSONAIR_APPLINK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AppsOnAir_AppLink",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17AppsOnAir_AppLink14AppLinkService")
@interface AppLinkService : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) AppLinkService * _Nonnull shared;)
...
/// hrlp to handle the latest link for universal link and custom URL schema
